    ...
    <div className='space-y-4'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>演示用：近一周点击与唯一访客</CardDescription>
        </CardHeader>
      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>对比上周 +12.4%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>环比提升 5.8%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周下降 3.2%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周 +18 秒</p>
          </CardContent>
        </Card>
      </div>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        <Card className='col-span-1 lg:col-span-4'>
          <CardHeader>
            ...
            <CardDescription>示例：主要入口渠道占比</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
                { name: '直接访问', value: 512 },
                { name: '论坛/社区', value: 238 },
                { name: '社交媒体', value: 174 },
                { name: '博客文章', value: 104 },
              ]}
              barClass='bg-primary'
        ...
        <Card className='col-span-1 lg:col-span-3'>
          <CardHeader>
            ...
            <CardDescription>演示：不同终端的访问比例</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
